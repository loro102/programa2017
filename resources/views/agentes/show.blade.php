            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row col-md-12">
                        {{ link_to_action('agenteController@index','Volver al listado de agentes',[],['class'=>'btn btn-sm btn-primary pull-left']) }}
                ...
                <div class="panel-body">
                    ...
                    <div>
                        <table class="table table-bordered table-striped col-md-10">
                            ...
                            @foreach($agente->customer->SortBy('nombre') as $i)
                                <tr>
                                    <td>{{link_to_action('clientes@show',$i->fullname,['id'=>$i->id],[])}}</td>
                                </tr>
                            @endforeach
                        </table>
                    </div>
